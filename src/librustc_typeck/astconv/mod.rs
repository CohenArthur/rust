...
pub use generics::AstConvGeneric;
...
use rustc_errors::{pluralize, struct_span_err, Applicability, ErrorReported, FatalError};
...
impl<'o, 'tcx> dyn AstConv<'tcx> + 'o {
    ...
    pub fn ast_path_substs_for_ty(
        ...
        if let Some(b) = assoc_bindings.first() {
            AstConvGeneric::prohibit_assoc_ty_binding(self.tcx(), b.span);
        }
    ...
    fn create_substs_for_ast_path<'a>(
        ...
        let arg_count = AstConvGeneric::check_generic_arg_count(
            tcx,
            span,
            &generic_params,
            &generic_args,
        ...
        let substs = AstConvGeneric::create_substs_for_generic_args(
            tcx,
            def_id,
            parent_substs,
            self_ty.is_some(),
    ...
    pub fn prohibit_generics<'a, T: IntoIterator<Item = &'a hir::PathSegment<'a>>>(
        ...
        for segment in segments {
            ...
            if let [binding, ..] = segment.generic_args().bindings {
                has_err = true;
                AstConvGeneric::prohibit_assoc_ty_binding(self.tcx(), binding.span);
            }
        }
        has_err
    }
